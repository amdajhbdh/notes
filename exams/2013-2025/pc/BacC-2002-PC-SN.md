...
Ministère de l'Enseignement Secondaire et Supérieur     Série : Mathématiques/T.M.G.M
Direction des Examens et de l'Evaluation                Durée : 4H Coefficient : 8/4
Service des Examens
            Sciences- physiques session normale 2002
Exercice 1
On donne les potentiels standards des deux couples redox suivants: H₂O₂/H₂O:
1,77V et O2/H2O2: 0,68V
1 Ecrire le bilan de la réaction naturelle entre les deux couples. (0,5pt)
2 On réalise en présence d'ions Fe³⁺        une telle décomposition. L'expérience est
...
est Vₘ = 24L/mol. On utilise V = 10 mL de solution de peroxyde d'hydrogène de
concentration molaire volumique C = 6 10⁻² molL⁻¹. On ajoute quelques gouttes du
...
2-1    Montrer    que la    tmin               0        5 10      15       20      30
concentration               VO2 formé en mL    0     1,5  2,7     3,6      4,4    5,5
volumique             du                                6 4       5        2     6
peroxyde d'hydrogène        [H₂O₂] restant en  6.
restant en solution est     mol/L             10⁻
de        la      forme:                       2
[H O₂   2 ] = C − αVO2
            V .Vₘ
Préciser la valeur de α.
2-2 Tracer la courbe [H₂O₂] = f(t) . Echelle sur l'axe des abscisses 1 cm représente 3
min, sur l'axe des ordonnés 2Cm représente 10⁻² mol/L
2-3 Donner la définition de la vitesse instantanée de disparition du peroxyde
d'hydrogène et la calculer en (mol./L/.mn) aux dates t₀         = 0 et t₁₅   = 15 mn.
Conclure.(1pt)
...
CA = 0,1 mol/L
−            Une solution aqueuse (B) d'une amine RNH₂ de concentration CB = 3,2 10⁻²
mol/L et de
−     pH = 11,4.
...
la valeur du pH de la solution (A). (0,75pt)
  ...
  En déduire le pKa du couple associé à l'amine RNH₂ (0,75pt).
  Exercice 3
...
3- Le côté
          B perpendiculaire au plan du cadre tandis que le
uniforme  JGad restera toujours plongé dans une région ou règne un champ magnétique
...
en fonction de la vitesse V puis en fonction du temps.     (1,5pt)
...
Exercice 4        JJG
Des ions 27Al³⁺ pénètrent en O avec une vitesse VO  horizontal de valeur Vo = 400 Km/s
...
1 - dansJGla  région  ABCD règne     un     champ   électrique
...
1.3 Trouver les coordonnées du point de sortie S₁ des ions du champ électrique.
1.4 Dans la région ABCD règne un champ électrique uniforme JG
    JJG                                                                                 E ' de même direction et
de même sens que VO                                 de valeur E' = 200 KV/m. Déterminer les coordonnées du point
de sortie S₂ des ions de ce champ et leur vitesse V₁ en ce point.                                 JG
2.Dans la    régionJJGABCD règne     un   champ   magnétique                            uniforme  B  horizontal,
...
2-3 Déterminer les coordonnées du point de sortie S₃ des ions de la région ABCD. On
rappelle l'équation du cercle : (x-xc)² + (y-yc) 2
3- Dans la région                                 = R² tel que C est le centre du JG                   cercle.
                                                  ABCD règne un champ magnétique uniforme B de même direction et
de même sens que JJG
    VO                                          de valeur B = 0,4T. Donner les coordonnées du point de sortie S₄
des ions dans la région ABCD et la vitesse V                              des ions en ce point. On donne : masse
du proton = masse neutron = 1,67. 10⁻²⁷Kg Charge élémentaire : e = 1,6. 10⁻¹⁹C (0,5pt)
Exercice 5
On considère trois dipôles D₁, D₂ et D₃ de nature inconnue ; un de ces trois dipôles est une
...
ci-dessus :                                                                             Dipôle      I(A)  Ieff
1 Calculer pour chaque dipôle les rapports UI    et UI eff . Montrer que                D₁          7,2   6,4
                                                  eff                                   D₂          3,75  5
l'analyse de ces résultats permet de déterminer la nature de                            D₃          0     10  -2
chaque dipôle.                                        (0,75pt)
...
4-2 pour une valeur déterminée de la fréquence f₀ on constate que la tension u(t) et i(t)
sont en phase.
Qu'appelle-t-on ce phénomène ? Calculer la valeur de la fréquence f₀                                 et celle de
l'intensité efficace I₀ correspondante. (0,75pt)
