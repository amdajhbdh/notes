---
tags: [bac, mauritania, 2002, complementaire-session, physics, chemistry, exam, 7C]
year: 2002
...
# BAC 2002 - Session Complementaire - Sciences Physiques
...
pH       3,1       3,2      3,3     3,5     3,8      4,1    4,3       4,4       4,5
                                                         ⎛ VB ⎞
1.1 Représenter graphiquement pH=f(x) avec x = log ⎜          ⎟ On prendra comme échelle
                                                         ⎝ VA ⎠
...
Exercices 5
1. A la haute altitude l'azote 147 N se transforme en 146 C sous l'effet de bombardement par
...
VB(mL)       10       10       10       10          10    20       30       40       50
VA(mL)       50       40       30       20          10    10       10       10       10
Log(VB/VA) -0,7       -0,6     -0,5     -0,3        0     0,3      0,5      0,6      ,0,7
pH           3,1      3,2      3,3      3,5         3,8   4,1      4,3      4,4      4,5
...
12n+2n+32=88       -> n =4 la formule brute est donc C4H8O2
1.2 HCOO-CH2-CH2-CH3 méthanoate de propyle
HCOO-CH(CH3)-CH3         méthanoate d’isopropyle
...
L’équation de la trajectoire y =f (x)
                  x − 1,1
De (2) t =                                  ; dans (3)on trouve y = −1, 1x2 + 1, 3x − 0, 6
                   2,14
...
à xD = 1,68m
                                 x − 1,1
  la durée de chute est : t D = D         = 0,27 s
                                  2,14
...
2.1 L’expression de i(t) dans l’intervalle [o; 40ms] :i(t) =at +b
 si t= 40.10-3 s       i =2A soit a =50 donc         i =50t
                   ⎡40ms;60ms ⎤
dans l’intervalle ⎢⎣          ⎥⎦
                               i(t) =a’t + b’
                -3
 si t= 40.10 s     i =2A soit 2 =40.10-3a’+b’ si t = 60.10-3s
   i = 0 soit 0 = 60.10-3a’+b’donc b’ = 6 a’ = -100 et i(t) = -100t+6
   2.2

   2.3 Lorsque tЄ ⎡⎢0; 40ms ⎤⎥            uAB= Ldi/dt  -> uAB= 50L
                         ⎣            ⎦
   A.N :        uAB =1V
                    ⎡40ms;60ms ⎤
        Lorsque tЄ ⎢⎣          ⎥⎦
   uAB= Ldi/dt  -> uAB= -100L                  A.N :   uAB =-2V
   2.4
...
t(année)       0          5600        11200                       16800    20.000
Adp/mn         1350       674         337                         168      113
...
Direction des Examens et de l'Evaluation                        Durée : 4H Coefficient : 8
Service des Examens
...
- [[BAC-2001-Complementaire]] - Année précédente
- [[BAC-2003-Complementaire]] - Année suivante
