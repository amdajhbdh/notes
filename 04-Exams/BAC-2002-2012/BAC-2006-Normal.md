---
tags: [bac, mauritania, 2006, normal-session, physics, chemistry, exam, 7C]
year: 2006
session: Normal
...
# BAC 2006 - Session Normal - Sciences Physiques
...
Exercice 1
On mélange dans un Becher un volume V1 = 50mL d'une solution d'iodure de
potassium (K++l-) de concentration molaire C1 = 5.10-3mol/L et un volume
V2 = 75mL de peroxodisulfate de potassium
(2K++ S2O82-) de concentration molaire
C2 = 2.102-mol/L . La solution dévient
...
iodure [I-]0 et peroxodisulfate ⎡⎣S 2O82− ⎤⎦ 0 .
En déduire le réactif limitant.                   (1 pt)
3 On étudie la vitesse de formation du diiode l2 en fonction du temps ; pour cela on
...
3.2 Calculer la vitesse moyenne de formation du diiode entre les instants t1 = 10mn
et t2 =55mn.         (0,5pt)
...
(A1): CH3-CH2-CH2-CH2OH; (A2): CH3-C(CH3)OH-CH3; (A3): CH3-CH(OH) -CH2-
CH3 ;
(A4): CH3-CH(CH3)-CH2OH.
...
   3. Ecrire l'équation de la réaction d'oxydation ménagée du composé (A3) avec le
   ...
   MnO4− / Mn 2+ .
4. On obtient un composé (E)en faisant réagir l'acide propanoïque avec le composé (A1).
   ...
   3 Exprimer l'énergie mécanique Em du système (ressort-masse-terre) en fonction de m, g, x,
   V et K.       (0,75pt)
   4 Déterminer la nature du mouvement et écrire son équation horaire si à l'instant t=0, x0=0
   et V0= -2m/s. (1pt)
...
et calculer la fréquence N1 du générateur.
...
2 On retire l'oscillographe et on branche dans le circuit, trois voltmètres V1, V2 et V3
comme l'indique la fig3: On trouve respectivement les tensions : U1 = 4,38V, U2=
0,57V et U3= 4,95V
Montrer que, dans ces conditions, le circuit est le siège
d'une résonance d'intensité. Quelle est l'indication de
l'ampèremètre A ? Donner l'expression de la fréquence N2
du générateur.
...
déduire les valeurs de L, C et N2.
...
S 2 O82 − + 2e −     2SO42 −
2I −     2e− + I 2
l’équation bilan : 2I − + S 2O82 −  ->  I 2 + 2SO42 −
2 Calcul des concentrations initiales :
⎡ I − ⎤ = C1 V1 A.N : ⎡ I − ⎤ =2.10-3mol/L
⎣ ⎦0        V         ⎣ ⎦0
⎡ S O 2 − ⎤ = C2 V2 A.N : ⎡ S O 2 − ⎤ =1,2.10-3mol/L.
⎣ 2 8 ⎦0        V            ⎣ 2 8 ⎦0
      ⎡S O 2 − ⎤          ⎡I− ⎤
      ⎣ 2 8 ⎦0            ⎣ ⎦0
Comme                           C’est I − qui est le réactif limitant.
          1                 2
3.1 On refroidit les prélèvements pour arrêter la réaction.
3.2 La vitesse moyenne de formation du diiode entre les instants t1 et t2.
                                                                                         [I 2 ]2 − [I 2 ]1
On utilise les deux points d’abscisses t1 et t2 de la courbe, on obtient : Vm =
                                                                                             t 2 − t1
soit Vm 1, 2.10−4 mol / L / mn
3.3 Définition de la vitesse de formation de I 2
C’est la dérivée de la concentration de I 2 par rapport au temps ce qui correspond au
coefficient directeur de la tangente à la courbe au point d’abscisse 20mn ;
             d ⎡I ⎤
soit : VI 2 = ⎣ 2 ⎦ VI 2 = 2 B 2 A 1, 9.10−4 mol / L / min
                          [I ] − [I ]
               dt            tB − t A
Vitesse de disparition de I − :
D’après l’équation bilan on a :
V(I − ) V(I 2 )
       =        ⇒ V(I − ) = 2V(I 2 ) Numériquement : V(I − ) = 3, 73.10−4 mol / L / mn
  2       1
3.4 t1/2=12,5 mn d’après la courbe.
Exercice 2
1 Les noms et les classes des alcools
A1 : butan-1-ol (alcool primaire)
A2 : 2-méthylpropan-2-ol (alcool tertiaire)
A3 : butan-2-ol (alcool secondaire)
A4: 2-méthylpropan-1-ol ( alcool primaire)



                                                     74
2 Les fonctions des produits obtenus par oxydation ménagée des alcools précédents :
- A1 et A4 étant des alcools primaires leur oxydation donne d’abord des aldéhydes puis
des acides carboxyliques.
- A3 est un alcool secondaire qui s’oxyde en une seule étape pour donner une cétone.
- A2 ne s’oxyde pas car il est tertiaire.
3 Equation d’oxydation ménagée du composé A3 par l’ion permanganate :
CH3 -CHOH–CH2-CH3 ' 2e- + CH3-CO-CH2-CH3 + 2 H+
MnO4- + 5e- + 8 H+ ' Mn2+ + 4 H2O
Equation bilan:
5 CH3-CHOH–CH2-CH3 + 2 MnO4- + 6 H+ Æ5CH3-CO-CH2-CH3 + 2Mn2+ + 8 H2O
4 Equation de la réaction entre A1 et l’acide propanoïque :
CH3–CH2 –CH2–CH2OH+CH3-CH2-COOH' CH3–CH2-COO-–CH2–CH2–CH2–CH3
...
2.1 Expression de l’énergie potentielle de pesanteur :
 Epp = −mgx
2.2 Expression de l’énergie potentielle élastique du ressort :
                               mg                 mg 2                       (mg)2
Epe = 1 K( ∆ + x)2 or ∆ =         ⇒ Epe = 1 K(x +   ) ⇔ Epe = 1 Kx 2 + mgx +
       2                       K          2       K           2               2K
4 Expression de l’énergie mécanique :
                                                         (mg)2
Em = Ec + Epp + Epe Soit Em = 1 mV 2 + 1 Kx 2 +
                                   2           2          2K
4 Nature du mouvement.
                                                   dEm
Le système étant conservatif Em = cte ⇒             dt
                                                       =0
⇒ maV + KVx = 0 ⇒ a + K x = 0
                           m
...
Comme Em = cte
                                           2
Soit Em = Em0 = 12 mV02 + 12 Kx02 + (mg)
                                     2K
Em = 0, 84j

                                                    75
Exercice 4
1.1 Caractéristiques du champ B :
      ...
      • Sens : donné par la règle de la main droite SN
      • Intensité : B = µ 0nI
      A.N : B=5,03.10-5T
1.2 Voir le schéma : Calcul de θ
...
u(10 )V         4              0            -4             0                     4
                                               ...
                                               76
3 Les expressions de la tension u DC
La tension aux bornes de la résistance a pour expression u AC = Ri celle aux bornes de
                                di
la bobine s’écrit u DC = ri + L dt
            u AC         du                        du
avec i =         ⇒ di = 1 AC soit u DC = r u AC + L AC
              R    dt R dt               R        R dt
Sur [0;30ms]
                   ⎧⎪a = du AC = 0, 5
u AC = at + b Avec ⎨        dt        Donc u AC = 0, 5t Soit u DC = 0, 2t + 5.10−3
                    ⎪⎩b = 0
Sur [30;40ms]
                     ⎧a' = du AC = −1, 5
                     ⎪
u AC = a't + b' Avec ⎨         dt        Donc u AC = −1, 5t + 6.10−2 soit u DC = −0, 6t + 9.10−3
                     ⎪⎩b ' = 6.10−2
Exercice 5
...
Um       = 2, 5x2 = 5V
     R
Um = 3, 5x2 = 7V
La période T=8x2,5.10-3=2.10-2s⇒ N1 = T1 = 50Hz
                                                     1
      1.2
   ...
   1.3 Calcul des résistances :
                   U   U
     U R = RI ⇒ R = R = mR soit R = 60Ω
                         I       I 2
               (R + r)I                    U
     cos ϕ =            ⇒ r = U cos ϕ − R = m cos ϕ − R soit r = 7, 9Ω
                  U           I            I 2
2 Résonance
                                                     77
u 3 = u1 + u 2
⇒ U 23 = U12 + U 22 + 2U1 .U 2 cos ϕ1 (1)
U 3 = U1 + U 2 ⇔ U 23 = U12 + U 22 + 2U1 .U 2 (2)
(1) = (2)
    ⇔ cos ϕ1 = 1 ⇒ ϕ1 = 0
d’où u 2 est confondue avec u1 ⇔ ϕ = 0 le circuit est donc en résonance.
L’ampèremètre indique l’intensité efficace maximale I 0 .
     U   U
I 0 = 3 = 3 = 73mA
     ΣR     R+r
...
U , UC et Ub sont égales ; soit Z = ZC = Zb
                   1                    1 2
c Z C = Zb ⇔         = r 2 + (Lω)2 ⇒ (    ) = r 2 + (Lω)2
                  Cω                   Cω
     1
⇒         Lω donc le circuit est capacitif
    Cω
                  1                1 2
et2 Z = ZC          = r 2 + (Lω −    )
                 Cω               Cω
                                      1 2                   1          1
soit r 2 + (Lω)2 = r 2 + (Lω −          ) 3⇔ − L ω = L ω −    ⇒ 2Lω =    4
                                     Cω                    Cω         Cω
                     1
en remplaçant          par 2Lω dans2 on
                    Cω
                                                              r
...
- [[BAC-2006-Complementaire]] - Session complémentaire
- [[BAC-2005-Normal]] - Année précédente
- [[BAC-2007-Normal]] - Année suivante
