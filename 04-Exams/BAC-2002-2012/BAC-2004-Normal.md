---
tags: [bac, mauritania, 2004, normal-session, physics, chemistry, exam, 7C]
year: 2004
session: Normal
...
# BAC 2004 - Session Normal - Sciences Physiques
...
Exercice 1 :                                                                                      -
On 2réalise     la réaction    d'oxydoréduction        entre   les couples   redox suivants : I2/l et
...
2 Calculer les concentrations t(min)                2,7 7,5 12 18 25 33 40 56
initiales des ions iodure I- et V (cm 3 )           1.1 3,2 4,8 6,2 7,4 8,4 9 9,7
                                   1
peroxodisulfate S 2O82− .         (0,75pt)
                                 C = [l 2 ](mol/L)
...
dans l'eau glacée.
L'équation        de       ce      dosage       est
I 2 + 2S 2O 32−  ->  2I − + S4O62−
3.1 Montrer que la concentration du diiode formé
                                             C1 V1
à la date t est donnée par la relation C =           puis
                                             2V
...
1.1 Calculer la vitesse V1 de ce satellite en fonction de r, de la masse M-11de la2 terre
                                                                                       2
                                                                                          et
de la constante    de  gravitation G.   A . N  : r=7000km    ;  G=6,67.10    N.m   /kg    et
M=6.1024kg .
                                                                   GmM       GmM
...
restera en contact avec les rails au cours de son déplacement.             (0,5pt)
3.2     Déterminer la valeur minimale de l'intensité I pour que le
...
Exercice 1
                                        2-   -            2-
1 Les demi équations sont :          S O + 2e
                                      2 8
                                                      2SO
                                                         4
                                                             et 2I-     -
...
S O + 2I  ->  2SO + I
 2 8          4   2
                                                       C V
   2 Calcul des concentrations initiales : ⎡⎣I- ⎤⎦ o = 1 1 = 0,2mol/L et
                                                       V
                   C  V
       ⎡S O2- ⎤ = 2 2 = 0,1mol/L
       ⎣ 2 8 ⎦o      V
   3.1 2S2O32- + I2  ->  2S4 O62- + 2I- d’après l’équation de dosage
   n     n
    I     S O2-                                 C V
      2 = 2 3      or n         = C V ⇒n = 1 1
     1      2           S O2-      11      I     2
                         2 3                2
                      n
                       I      C V
   ...
   D’où le tableau :
        t(min)     2,7 7,5 12 18 25 33 40 56
                3
        V1(cm ) 1,1 3,2 4,8 6,2 7,4 8,4 9       9,7
              -3
        Cx10       0,55 1,6 2,4 3,1 3,7 4,2 4,5 4,85

   3.2.1     La vitesse de formation de I2 est la dérivée de la concentration de I2 par
                              d ⎡I ⎤
             rapport à t : v = ⎣ 2 ⎦ , elle correspond au coefficient directeur de la
                                dt
             tangente à la courbe au point d’abscisse considérée t.
                                           -3
                                (5 -1,5).10              -5
             à t=20min V20 =                    = 8,75.10 mol/L/min
                                     40
   3.2.2     La vitesse moyenne de formation de I2 est le rapport de la variation de la
...
1.1 Calcul de V1
     ...
     ⇒m.u
      En projetant sur la normale on obtient an=F /m avec
                                                         GM
F=GMm/r12 et an=v12/r1 ⇒ V1 =                                A.N : V1=7,5.103m/s
                                                          r1
1.2      Expression de l’énergie mécanique
                                1       GM       GMm         GMm            GMm       GMm
          Em = Ec + Ep =            m        +           -         ⇒ Em =         -
                                2       r            R        r              R        2r
                    9
A.N :Em=7.10 J
1.3 L’énergie E à fournir au satellite
                                    GMm ⎛ 1 1 ⎞                7
         E =E’m-Em Em =                      ⎜ - ⎟ A.N : E=8.10 J
                                        2    ⎝ r r' ⎠
2.1     Expression de la vitesse angulaire
...
3.2      La valeur minimale de I pour que la tige monte :
...
-P+Fm =ma       ⇒ Fm =m(a+g) ⇒ I=
                                      lB
                                       mg
       I est minimale si a = 0 ⇒ Im =      A.N :Im=10A
                                       lB
3.3      Nature du mouvement :
...
On peut alors écrire : v '2 − v 2 = −2g(h '− h) où h’ est la hauteur maximale atteinte.
                                                                                   v2
Calcul de cette hauteur h’ à la quelle monte la tige : au sommet v'=0 ⇒ h'=           +h
                                                                                   2g
A.N : h’=0,2m
...
• Le déphasage ϕ de la tension par rapport à l’intensité ϕ = ω∆t = 2$\pi$N avec
      ...
      ∆t=1,25ms ⇒ ϕ =    soit ϕ = − car le circuit est capacitif.
                       4           4
                                                                −1            1
•     Déduction de la capacité C du condensateur : tan gϕ =        = -1 ⇒ C=    A.N :
                                                              RCω            Rω
      C≈8µF.

                                              42
2.1    Résonance u = u R + u D
⇒ U 2 = U 2R + U D
                 2
                   + 2U R .U D cos ϕ1
         U 2 − (U 2R + U D
...
le circuit est donc en résonance.
                                                          UR     U.R
Déduction de la résistance r : U = (R + r)I et I =           ⇒r=     −R         A.N : r=40Ω
                                                           R     UR
2.2   D’après l’exercice les tensions U D , UC et Ub sont égales ;
                               1                    1                1 2
      soit Z D = ZC = Zb ⇔       = r 2 + (Lω)2 cet    = r 2 + (Lω −    ) 2
                              Cω                   Cω               Cω
                                         1 2
      et r 2 + (Lω)2 = r 2 + (Lω −         ) 3
                                        Cω
                    1          1
3⇔ − Lω = L ω −       ⇒ 2Lω =    4
                   Cω         Cω
                 1
en remplaçant      par 2Lω dans2 on obtient
                Cω
                                                      r
(2Lω)2 = r 2 + (Lω)2 ⇔ 3(Lω)2 = r 2 ⇒ L =                   A.N : L=37.10-3H.
                                                 ω 3
                       1
D’après4on a C =                        A.N : C=3,4.10-5F
                    2Lω2
                                                 ...
                                                 43
REPUBLIQUE ISLAMIQUE                                          Honneur Fraternité Justice
DE MAURITANIE
Ministère de l'Enseignement                            Série : Mathématiques/T.M.G.M
Secondaire et Supérieur
Direction des Examens et de                                   Durée : 4H Coefficient : 8
l'Evaluation
Service des Examens
...
- [[BAC-2004-Complementaire]] - Session complémentaire
- [[BAC-2003-Normal]] - Année précédente
- [[BAC-2005-Normal]] - Année suivante
