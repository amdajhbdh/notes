---
tags: [bac, mauritania, 2003, complementaire-session, physics, chemistry, exam, 7C]
year: 2003
...
# BAC 2003 - Session Complementaire - Sciences Physiques
...
soude vb suivants:
Compléter le tableau et tracer la courbe t(min)          0    3    8 28 38 48 68
...
vitesse initiale. Le solide arrive sur le plateau et s'y encastre
 (voir fig 2)
3.1 Déterminer la vitesse du solide S juste avant le choc si h=10cm.                     p
3.2 Donner l'expression de l'énergie mécanique du système (plateau, solide S, ressort,
terre) quand le solide est à une position z quelconque.                                  p
3.3 Ce système étant conservatif ; calculer alors la valeur de son énergie mécanique
totale si la vitesse juste après le choc est v = 0,94 m/s.                               p
3.4 Déduire de ce qui précède les positions limites atteintes par le plateau.            p
3.5 Déterminer pour une position quelconque z l'accélération de ce système.              p
Exercice 4
...
ondes dans l'eau est V = 10m/s. (1pt)
                                          Corrigé
Exercice 1
1) CH3-COOH +CH3-CH2-CHOH-CH3                   CH3-COO-CH(CH3)H-CH2-
CH3+H2O
...
-CbVb ou            no = 0,2/10 = 0,02mol
2.2.2
    t(min)            0       3           8          28    38      48       68
   Vb(Cm3)           20      16         13,5        8,5   7,2      6,9      6,9
              -3
 nE(mol).10           0       4          6,5        11,5  12,8    13,1     13,1
...
Les espèces chimiques dans la solution sont: H3O+,H2O, OH - ;,CH3-COOH, CH3-
COO-
...
3.2Les espèces chimiques dans la solution: Na+ ;H3O+,H2O, OH - ; CH3-COOH, CH3-
COO-
pH = 4, 9 ⇒ [H 3O + ] = 1,26.10−5 mol / L
[OH − ] = 7, 9.10−10 mol / L
                [CH 3 − COO − ]   [CH 3 − COO − ]
pH = pKa + log                  ⇒                 = 10pH −pK = 1,26                      a
...
[Na + ] + [H 3O + ] = [OH − ] + [CH 3 − COO − ]
[OH − ] ∠∠ [H 3O + ]
[Na + ] = [CH 3 − COO − ] − [H 3O + ]     3, 8.10−3 mol / L
               n
[Na + ] =           ⇒ n = [Na + ].(V1 + V2 )          2, 3.10−4 mol / L
            V1 + V2
...
•• K                                                K
Z+   Z =0                                   w=        = 10rd / s
   m          ; le mvt est r.S de pulsation         m            et d’équation
Z = ZmCos(wt + ϕ)
A t= 0
     ⎡ Z 0 = 2 .1 0 − 2 m
     ⎢⎣ V 0 ≺ 0 = − 0 , 2 m / s
...
1.2 La force Fm est verticale et ascendante ,la force Fe est opposée à la force
 -> 
              -> 
Fm ( q ∠ 0 ⇒ E est dirigé vers le haut ).

                                                                        E
                                     Fe = Fm ⇒ eE = eV0B        V0 =      = 4.104 m / s.
Le mvt des ions est r.u                                                 B
...
La projection de (1) sur la normale donne :
   ...
   Fm      V2  eV B
an =   an = 0 = 0
   m        R   m                       la trajectoire est circulaire
   mV0
R=
   eB
...
- [[BAC-2002-Complementaire]] - Année précédente
- [[BAC-2004-Complementaire]] - Année suivante
