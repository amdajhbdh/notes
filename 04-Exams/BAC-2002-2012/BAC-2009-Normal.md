---
tags: [bac, mauritania, 2009, normal-session, physics, chemistry, exam, 7C]
year: 2009
session: Normal
...
# BAC 2009 - Session Normal - Sciences Physiques
...
Pour simplifier, l'acide acétylsalicylique de formule brute C9H7O4H sera cosigné par
AH.
...
S de volume Vs=100mL. On prélève un volume VA=10mL de la solution S que l'on
dose avec une solution aqueuse d'hydroxyde de sodium de concentration molaire
 CB=2.10-2mol/L en présence d'indicateur coloré convenablement choisi. L'équivalence
...
Exercice 2 )
La formule moléculaire d'un alcool A est C3H7OH.
1 Quelle sont les formules semi développées possibles correspondantes à cette formule
...
magnétique uniforme B orthogonal au plan de la figure. Le
...
1.2 Etablir l'expression de la vitesse V1 de l'ion 23 He 2+ au trou B en fonction de sa
masse ml, de sa charge q et de la tension U. Calculer V1. A.N: e=1,6.10-19C,
|U|=100V, mp=l,67.1027kg, B=3.10-2T. (1pt)
2 Les ions 23 He 2+ pénètrent en O dans le champ magnétique uniforme B avec la
    vitesse V1.
...
carré de l'impédance (Z2) en fonction de ૑2.
1 Trouver l'expression théorique de Z2 en fonction de ૑2. Montrer
qu'elle est conforme à la relation obtenue à partir du graphe,       (1pt)
2 Déduire de ce qui précède la valeur de la résistance r de la bobine ainsi que celle de
   son inductance L                                                  (1pt)
3 On donne à la pulsation la valeur ω = 50 3rad / s .
...
circulant soit maximale. Quelle est alors la valeur l0 de cette
intensité ?                                                          (1pt)
3.3Calculer alors la puissance moyenne électrique P0
    consommée dans le nouveau circuit.                                                   (0,5p
...
1.1 Définition de la vitesse de formation de AH
                                                                          ...
                                                                          dC
C’est la dérivée de la concentration C par rapport au temps V(AH) =          ce qui
                                                                          dt
...
Vt =150min =
               tB - t A
                    (3, 7 - 1, 7)10-5
soit Vt =150min =                     = 8.10-8 mol/L/min
                           250
1.2 t1/2=70 mn d’après la courbe.
2.1 L’équivalence correspond au changement de couleur de l’indicateur coloré.
2.2 L’équation de la réaction du dosage : AH + OH -  ->  A- + H 2O
2.3 Calcul de Ca :
                                       Cb VbE
na = nb ⇔ Ca Va = Cb VbE ⇒ Ca =
                                         V
            2.10-2 x13, 9
soit Ca =                 = 27, 8.10-3 mol/L
                 10
La masse d’acide dans chaque comprimé :
      n      m
Ca =     =       ⇒ m = Ca VS M
     VS VS M
m = 27, 8.10-3 x10-1 x180 = 500, 4mg
Exercice 2
1 Les formules semi développées correspondantes à l’alcool de formule brute C3
H7OH sont :
CH3-CH(OH)- CH3
(propan-2-ol) alcool secondaire.
CH3- CH2 –CH2OH (propan-1-ol) primaire.
2 L’oxydation ménagée des alcools précédents:
L’utilisation de la DNPH lors de l’étude d’un composé permet de mettre en évidence
la présence du groupement carbonyle



qui se trouve aussi bien dans les aldéhydes que dans les cétones.
Comme le test est positif et qu’on observe un précipité jaune :
- Si l’alcool est secondaire son oxydation ménagée donne la cétone
CH3-CO- CH3(propane-2-one)
- Si l’alcool est primaire son oxydation ménagée donne l’aldéhyde
CH3-CH2- CHO (propanal)
3 On ajoute à la 2ème moitié de la solution verte, par exemple, le réactif de Schiff qui
permet de distinguer les aldéhydes des cétones
Lorsque ce test est positif on observe une coloration rose preuve que le composé B est
un aldéhyde et que l’alcool A primaire est
 le propan-1-ol.
Lorsque ce test est négatif c’est la preuve que le composé B est une cétone et que
l’alcool A secondaire est le propan-2-ol.
Exercice 3
                                                   121
...
-T = ma ⇔ -kx = ma ⇒ a + K x = 0
                           m
C’est l’équation différentielle caractérisant un mouvement rectiligne sinusoïdal de
              K
pulsation ω = m
1.2 La valeur de la pulsation
Par identification entre l’équation différentielle et l’équation donnée, on obtient ω2 =
400
⇒ ω =20 rad/s
1.3 L’équation horaire du mouvement :
x = xm cos(ωt + ϕ )
La pulsation : ω =20 rad/s et l’amplitude xm=4cm.
Calcul de la phase initial ϕ
          x0
cos ϕ =      =1 ⇒ ϕ = 0
          xm
...
2.2 Comparaison des mouvements :
                                                             PQ 0, 25                λ
   • Comparaison des mouvements de P et Q entre eux :           =      = 0, 5 ⇒ PQ =
                                                              λ   0, 5               2
   Les points P et Q vibrent en opposition de phase.
   • Comparaison des mouvements de P et Q avec celui de G :
   - Entre P et G :
   PG 0,125                 λ
      =      = 0, 25 ⇒ PG =        Les
    λ   0, 5                4
   points P et G vibrent en quadrature de
   phase.
   - Entre G et Q :
          GQ 0, 375                3λ
             =      = 0, 75 ⇒ GQ =
           λ   0, 5                 4
   Les points G et Q vibrent en quadrature de phase.
                                            ...
                                            122
Exercice 4
1.1 Le signe de U = VP1 − VP2 :
Les ions sont chargés positivement, ils se déplacent de P1 vers P2 sous
l’action de la force électrique F . Les ions sont donc attirés par P2 qui est
chargée négativement ; P1 est alors chargée positivement c'est-à-dire
que
VP > VP ⇒ VP − VP > 0
   1     2       1    2
⇔ U> 0
...
La RFD permet d’écrire $\sum$ F = m1a ⇒ a =          1
                                                m
                                                  1
A tout instant, on a :.
• a ⊥ V1 L’accélération tangentielle est donc nulle
          dV
⇒ at =       = 0 ⇒ V = Cste
          dt
⇒ le mouvement est uniforme
                                                    m1V12
• En projetant sur la normale, on trouve qV1B =           ⇒
                                                     r1
       m1V1
r1 =        = cte
        qB
⇒ le mouvement est circulaire. En définitif le mouvement
...
affine dont la représentation est une droite.
2 Le graphe est une droite dont l’équation est :
Z2 = aω2 + b 2
     ⎧          2   (10, 5 − 2, 5).103
     ⎪⎪a = ∆Z 2 =                      =1
avec ⎨ ∆ω              (8 − 0).103
      ⎪             3
      ⎪⎩b = 2, 5.10
  Par identification entre les relations 1 et 2, on obtient L = 1H et r2 =2500Ω2 ⇔
r =50Ω
3.1 Calcul de l’intensité efficace I pour ω = 50 3
      U
 I=
      Z
Pour cette valeur de ω ; Z=100Ω, Soit I = 150 = 1,5A
                                                 100
                                                                                         1
3.2 L’intensité efficace est maximale à la résonance soit lorsque LCω2 = 1 ⇒ C = 2
                                                                                ω L
               -4
soit C= 1,3.10 F.
Calcul de l’intensité maximale I0 :

                                                124
    U          150
I =   soit I =     = 3A
 0 r        0 50
3.3 Calcul de la puissance moyenne électrique maximale P0 :
P = rI 2 ⇔P0 =450 W
 0    0
                     P            I
4 Montrons que si P = 0 alors I = 0 :
                          2         2
...
- [[BAC-2009-Complementaire]] - Session complémentaire
- [[BAC-2008-Normal]] - Année précédente
- [[BAC-2010-Normal]] - Année suivante
