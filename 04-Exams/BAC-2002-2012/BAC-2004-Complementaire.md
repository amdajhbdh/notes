---
tags: [bac, mauritania, 2004, complementaire-session, physics, chemistry, exam, 7C]
year: 2004
...
# BAC 2004 - Session Complementaire - Sciences Physiques
...
On obtient les résultats suivants :
   Vb(cm3) 0       5      10 15 20 24 28 30 32 34 36 40
   pH        2,4 3,4 3,6 3,7 3,9 4,3 5,0 5,5 10,9 11,4 11,5 11,7
...
temps l'instant du passage par O dans le sens positif.                                      (1p
...
2 Déterminer la longueur l du fil utilisé.   (0,5pt)
...
magnétique B à l'intérieur du solénoïde.                                                    (1p
...
                                          Corrigé
   ...
   C ) CH3-CH(CH3)-COOH (acide carboxylique)                  D ) CH3-CH2-COCl (
   Chlorure d’acide)
   ...
   MnO-     +
      4 + 8H + 5e
                 -       Mn2+ + 4H2 O
   CH3-CH(CH3)-CHO + H2O            ' CH3-CH(CH3)-COOH + 2H+ + 2e-

   Equation bilan:on multiplie la premiere equation par 2 et la deuxieme par 5
   5CH3 - CH - CHO    + 2MnO2- + 6H+       ->       5CH3 - CH - COOH    +   2Mn2+ + 3H2 O
                            4
             |                                            |
           CH3                                           CH3
...
E.E.N : [HCOO − ] = [H 3O + ] + [Na + ] − [OH − ]
            A.N : [HCOO − ]     4, 3.10−2 mol / L


                                                    48
                                                          CaVa     30.0,1
  Conservation de la matière : Ca ' =                            =        = 5,17.10−2 mol / L
                                                         Va + Vb    58
   [HCOO − ] + [HCOOH ] = Ca '
   [HCOOH ] = Ca '− [HCOO − ]
   [HCOOH ] = Ca '− ([Na + ] + [H 3O + ] − [OH − ])
...
Exercice4
1.1
    • Observation : Lorsque la source émet une lumière monochromatique, on
      observe un système constitué de franges alternativement brillantes et sombres.
    • Expression de la différence de marche δ
       En utilisant le théorème de Pythagore on
      trouve :
                       a
         d2 = D2 + (x - )2
          1            2
   ...
   on pose
                        ...
                        δ = d2 - d1 =
                                        D
                                                          ...
                                                          50
         Si x=12,6mm alors δ =4,2mm
      • Déduction de la longueur d’onde λ si le point M est le milieu de la 7ème frange
        brillante(K=7).
        Les franges brillantes sont caractérisées par une différence de marche telle que
                           ax
          δ =kλ soit λ =        A.N : λ=0,6µm
                           Dk
...
2.3 Pour que la corde apparaît unique et immobile, il faut que la fréquence Ne du
      stroboscope vérifie la relation Ne = N/k. Cette fréquence serait maximale si k est
      minimale soit k=1 ce qui donne Nemax=N=50Hz.
   Exercice5
                                                                    N 1
      1   Les spires sont jointives si et seulement si               = avec d le diamètre du fil. La
                                                                    l d
      ...
      2 La longueur l du fil conducteur : l=NC où C est la circonférence d’une spire,
        soit C = dCx π soit l=N.dC. π A.N : l=125,7m
                                                           ...
                                                           51
                                                                                 N
      3   Calcul de l’inductance L : Φ = Li           et Φ = NSB   avec B = µ0       i par identification
                                                                                 l
                           N2µ0 S
          on obtient L =                  A.N : L=2,6.10-3 H
                                   l
                                                                                      di
      4   La tension U1 au bornes de la bobine : U1=Ri – e avec e = - L                    = 0 soitU1=Ri
                                                                                      dt
         A.N : U1=40V.
      Caractéristiques du champ B :
         • Origine : milieu du solénoïde
         • Direction : l’axe du solénoïde
         • Sens : donné par la règle de la main droite
                                               N                 -3
          • Intensité : B = µ 0 nI = µ 0         I A.N : B=4,2.10 T
                                               l
5.1       Les intervalles où le flux varie sont les intervalles où l’intensité varie c'est-à-
          dire [2.10-2 ; 4.10-2 ] et [6.10-2 ; 8.10-2 ] .
5.2       Calcul de la f.e.m d’auto-induction
                   dΦ         di
            e= -        =-L            soit
                   dt     dt
           sur [2.10 ; 4.10-2 ] e=0,08V
                    -2

        sur [6.10-2 ; 8.10-2 ] e =-0,08V
5.3 L’expression de la tension aux bornes de la bobine sur ces intervalles :
   sur [2.10-2 ; 4.10-2 ] u=ri-e avec i = -30t +0,9
   sur [6.10-2 ; 8.10-2 ] u=ri-e avec i = 30t - 2,1
...
- [[BAC-2004-Normal]] - Session normale
- [[BAC-2003-Complementaire]] - Année précédente
- [[BAC-2005-Complementaire]] - Année suivante
